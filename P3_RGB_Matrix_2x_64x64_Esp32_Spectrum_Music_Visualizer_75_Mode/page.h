...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
            spee0  = this.responseXML.getElementsByTagName('analog')[0].childNodes[0].nodeValue;
            spee1  = this.responseXML.getElementsByTagName('analog')[1].childNodes[0].nodeValue;
            spee2  = this.responseXML.getElementsByTagName('analog')[2].childNodes[0].nodeValue;
    ...
    document.getElementById("Sped2").innerHTML = spee2/1000 + "s";
  ...
  xhttp.send();
            setTimeout('GetArduinodata()', 60000);
        }
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed0" min="0" max="50" value="7" class="slider" id="mySpeed0">
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed1" min="20" max="250" value="100" class="slider" id="mySpeed1">
        <button class="button-blue" onclick="myFunctionS1()" style="width:20%"><b><span>Volume</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed2" min="2" max="240" value="10" class="slider" id="mySpeed2">
        <button class="button-blue" onclick="myFunctionS2()" style="width:20%"><b><span>Timer</span></b></button>
